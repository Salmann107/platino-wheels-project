  ...
  return (
    <div class = 'policy'>
      ...
      <ul class = 'policy2'>
        ...
        <li>Watch out for false emails. PlatinoWheels would never contact you by mail to ask you for your account details or password. In the unlikely event of receiving email from James Edition asking you about your details, please contact us.</li>
      </ul>
      </div>
  )
}
